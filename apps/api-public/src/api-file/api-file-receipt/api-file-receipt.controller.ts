...
export class ApiFileReceiptController {
  ...
  async downloadExcelFileExample(@External() { user, organization }: TExternal) {
    return await this.apiFileProductDownloadExcel.downloadExcelExample()
  }
  ...
  async uploadExcelForGenerateReceiptItemList(
    ...
    return await this.apiFileReceiptUploadExcel.uploadExcelForGenerateReceiptItemList({ oid, userId: uid, file })
  }
}
