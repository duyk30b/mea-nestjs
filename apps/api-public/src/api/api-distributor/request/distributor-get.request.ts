...
import { DistributorFilterQuery, DistributorRelationQuery, DistributorSortQuery } from './distributor-options.request'
...
export class DistributorPaginationQuery extends IntersectionType(DistributorGetQuery, PaginationQuery) {}

export class DistributorGetManyQuery extends IntersectionType(
    PickType(DistributorGetQuery, ['filter', 'relation']),
    LimitQuery
) {}
