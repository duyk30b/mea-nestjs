...
import { TicketRadiologyGetOneQuery, TicketRadiologyPaginationQuery, TicketRadiologyPostQuery, TicketRadiologyUpdateResultBody } from './request'
...
export class ApiTicketRadiologyController {
  ...
  async updateResult(
    ...
    console.log('🚀 ~ api-ticket-radiology.controller.ts:58 ~ ApiTicketRadiologyController ~ query:', query)
  ...
  async cancelResultTicketRadiology(@External() { oid }: TExternal, @Param() { id }: IdParam) {
