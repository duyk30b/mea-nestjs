...
export class ApiTicketSpaController {
  ...
  @HasPermission(PermissionId.TICKET_SPA_CHANGE_TICKET_PROCEDURE_LIST)
  ...
  // @HasPermission(PermissionId.TICKET_SPA_CHANGE_TICKET_RADIOLOGY_LIST)
  ...
  // @HasPermission(PermissionId.TICKET_SPA_CHANGE_CONSUMABLE)
  ...
  // @HasPermission(PermissionId.TICKET_SPA_CHANGE_PRESCRIPTION)
  ...
  // @HasPermission(PermissionId.TICKET_SPA_CHANGE_ITEMS_MONEY)
