...
import { ProcedureFilterQuery, ProcedureRelationQuery, ProcedureSortQuery } from './procedure-options.request'
...
export class ProcedurePaginationQuery extends IntersectionType(ProcedureGetQuery, PaginationQuery) {}
