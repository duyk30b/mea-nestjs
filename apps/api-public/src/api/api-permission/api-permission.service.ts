...
export class ApiPermissionService {
  ...
  async initData() {
    ...
    const permissionTicketOrder: Permission[] = [
      ...
      {
        id: PermissionId.TICKET_ORDER_CANCEL_DESTROY,
        level: 2,
        code: PermissionId[PermissionId.TICKET_ORDER_CANCEL_DESTROY],
        isActive: 1,
        pathId: `${PermissionId.TICKET_ORDER}.${PermissionId.TICKET_ORDER_CANCEL_DESTROY}`,
    ...
    const permissionTicketClinic: Permission[] = [
      ...
      {
        id: PermissionId.TICKET_CLINIC_UPDATE_TICKET_USER_LIST,
        level: 2,
        code: PermissionId[PermissionId.TICKET_CLINIC_UPDATE_TICKET_USER_LIST],
        isActive: 1,
        pathId: `${PermissionId.TICKET_CLINIC}.${PermissionId.TICKET_CLINIC_UPDATE_TICKET_USER_LIST}`,
      ...
      {
        id: PermissionId.TICKET_CLINIC_UPDATE_USER_COMMISSION,
        level: 2,
        code: PermissionId[PermissionId.TICKET_CLINIC_UPDATE_USER_COMMISSION],
        isActive: 1,
        pathId: `${PermissionId.TICKET_CLINIC}.${PermissionId.TICKET_CLINIC_UPDATE_USER_COMMISSION}`,
