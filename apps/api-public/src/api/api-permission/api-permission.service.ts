...
export class ApiPermissionService {
  ...
  async initData() {
    ...
    const permissionMasterData: Permission[] = [
      ...
      {
        id: PermissionId.MASTER_DATA_PARACLINICAL,
        level: 2,
        code: PermissionId[PermissionId.MASTER_DATA_PARACLINICAL],
        isActive: 1,
        pathId: `${PermissionId.MASTER_DATA}.${PermissionId.MASTER_DATA_PARACLINICAL}`,
        name: 'Quản lý phiếu cận lâm sàng',
        parentId: PermissionId.MASTER_DATA,
        rootId: PermissionId.MASTER_DATA,
      },
      {
      ...
      {
        id: PermissionId.MASTER_DATA_PARACLINICAL_GROUP,
        level: 2,
        code: PermissionId[PermissionId.MASTER_DATA_PARACLINICAL_GROUP],
        isActive: 1,
        pathId: `${PermissionId.MASTER_DATA}.${PermissionId.MASTER_DATA_PARACLINICAL_GROUP}`,
        name: 'Quản lý danh sách nhóm phiếu cận lâm sàng',
        parentId: PermissionId.MASTER_DATA,
        rootId: PermissionId.MASTER_DATA,
      },
      {
    ...
    const permissionTicketParaclinical: Permission[] = [
      {
        id: PermissionId.TICKET_PARACLINICAL,
        level: 1,
        code: PermissionId[PermissionId.TICKET_PARACLINICAL],
        isActive: 1,
        pathId: `${PermissionId.TICKET_PARACLINICAL}`,
        name: 'Quản lý kết quả phiếu cận lâm sàng',
        parentId: 0,
        rootId: PermissionId.TICKET_PARACLINICAL,
      },
      {
        id: PermissionId.TICKET_PARACLINICAL_READ,
        level: 2,
        code: PermissionId[PermissionId.TICKET_PARACLINICAL_READ],
        isActive: 1,
        pathId: `${PermissionId.TICKET_PARACLINICAL}.${PermissionId.TICKET_PARACLINICAL_READ}`,
        name: 'Xem kết quả phiếu cận lâm sàng',
        parentId: PermissionId.TICKET_PARACLINICAL,
        rootId: PermissionId.TICKET_PARACLINICAL,
      },
      {
        id: PermissionId.TICKET_PARACLINICAL_CREATE,
        level: 2,
        code: PermissionId[PermissionId.TICKET_PARACLINICAL_CREATE],
        isActive: 1,
        pathId: `${PermissionId.TICKET_PARACLINICAL}.${PermissionId.TICKET_PARACLINICAL_CREATE}`,
        name: 'Tạo kết quả phiếu cận lâm sàng',
        parentId: PermissionId.TICKET_PARACLINICAL,
        rootId: PermissionId.TICKET_PARACLINICAL,
      },
      {
        id: PermissionId.TICKET_PARACLINICAL_UPDATE,
        level: 2,
        code: PermissionId[PermissionId.TICKET_PARACLINICAL_UPDATE],
        isActive: 1,
        pathId: `${PermissionId.TICKET_PARACLINICAL}.${PermissionId.TICKET_PARACLINICAL_UPDATE}`,
        name: 'Sửa kết quả phiếu cận lâm sàng',
        parentId: PermissionId.TICKET_PARACLINICAL,
        rootId: PermissionId.TICKET_PARACLINICAL,
      },
    ]
    ...
    const permissionTicketClinic: Permission[] = [
      ...
      {
        id: PermissionId.TICKET_CLINIC_UPDATE_TICKET_PARACLINICAL_LIST,
        level: 2,
        code: PermissionId[PermissionId.TICKET_CLINIC_UPDATE_TICKET_PARACLINICAL_LIST],
        isActive: 1,
        pathId: `${PermissionId.TICKET_CLINIC}.${PermissionId.TICKET_CLINIC_UPDATE_TICKET_PARACLINICAL_LIST}`,
    ...
    const permissionTicketBasic: Permission[] = [
      {
