...
export class ApiPermissionService {
  ...
  async initData() {
    ...
    const permissionInvoice: Permission[] = [
      ...
      {
        id: PermissionId.INVOICE_DRAFT,
        level: 2,
        code: PermissionId[PermissionId.INVOICE_DRAFT],
        isActive: 1,
        pathId: `${PermissionId.INVOICE}.${PermissionId.INVOICE_DRAFT}`,
        name: 'Tạo, sửa hóa đơn nháp',
        parentId: PermissionId.INVOICE,
        rootId: PermissionId.INVOICE,
      },
      {
      ...
      {
        id: PermissionId.INVOICE_REFUND_OVERPAID,
        level: 2,
        code: PermissionId[PermissionId.INVOICE_REFUND_OVERPAID],
        isActive: 1,
        pathId: `${PermissionId.INVOICE}.${PermissionId.INVOICE_REFUND_OVERPAID}`,
        name: 'Hoàn trả tiền tạm ứng',
        parentId: PermissionId.INVOICE,
        rootId: PermissionId.INVOICE,
      },
      ...
      {
        id: PermissionId.INVOICE_FORCE_UPDATE,
        level: 2,
        code: PermissionId[PermissionId.INVOICE_FORCE_UPDATE],
        isActive: 1,
        pathId: `${PermissionId.INVOICE}.${PermissionId.INVOICE_FORCE_UPDATE}`,
        name: 'Sửa đơn hàng đã thanh toán hoặc đã gưi hàng',
        parentId: PermissionId.INVOICE,
        rootId: PermissionId.INVOICE,
      },
      {
        id: PermissionId.INVOICE_CANCEL,
        level: 2,
        code: PermissionId[PermissionId.INVOICE_CANCEL],
        isActive: 1,
        pathId: `${PermissionId.INVOICE}.${PermissionId.INVOICE_CANCEL}`,
        name: 'Hủy đơn',
        parentId: PermissionId.INVOICE,
        rootId: PermissionId.INVOICE,
      },
