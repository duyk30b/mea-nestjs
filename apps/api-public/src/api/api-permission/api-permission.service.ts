...
export class ApiPermissionService {
  ...
  async initData() {
    ...
    const permissionProduct: Permission[] = [
      ...
      {
        id: PermissionId.PRODUCT_BATCH_READ,
        level: 2,
        code: PermissionId[PermissionId.PRODUCT_BATCH_READ],
        isActive: 1,
        pathId: `${PermissionId.PRODUCT}.${PermissionId.PRODUCT_BATCH_READ}`,
        name: 'Xem lô hàng',
        parentId: PermissionId.PRODUCT,
        rootId: PermissionId.PRODUCT,
      },
      {
        id: PermissionId.PRODUCT_BATCH_READ_COST_PRICE,
        level: 2,
        code: PermissionId[PermissionId.PRODUCT_BATCH_READ_COST_PRICE],
        isActive: 1,
        pathId: `${PermissionId.PRODUCT}.${PermissionId.PRODUCT_BATCH_READ_COST_PRICE}`,
        name: 'Xem giá nhập',
        parentId: PermissionId.PRODUCT,
        rootId: PermissionId.PRODUCT,
      },
      {
        id: PermissionId.PRODUCT_BATCH_CREATE,
        level: 2,
        code: PermissionId[PermissionId.PRODUCT_BATCH_CREATE],
        isActive: 1,
        pathId: `${PermissionId.PRODUCT}.${PermissionId.PRODUCT_BATCH_CREATE}`,
        name: 'Thêm lô hàng',
        parentId: PermissionId.PRODUCT,
        rootId: PermissionId.PRODUCT,
      },
      {
        id: PermissionId.PRODUCT_BATCH_UPDATE,
        level: 2,
        code: PermissionId[PermissionId.PRODUCT_BATCH_UPDATE],
        isActive: 1,
        pathId: `${PermissionId.PRODUCT}.${PermissionId.PRODUCT_BATCH_UPDATE}`,
        name: 'Sửa lô hàng',
        parentId: PermissionId.PRODUCT,
        rootId: PermissionId.PRODUCT,
      },
      {
        id: PermissionId.PRODUCT_BATCH_DELETE,
        level: 2,
        code: PermissionId[PermissionId.PRODUCT_BATCH_DELETE],
        isActive: 1,
        pathId: `${PermissionId.PRODUCT}.${PermissionId.PRODUCT_BATCH_DELETE}`,
        name: 'Xóa lô hàng',
        parentId: PermissionId.PRODUCT,
        rootId: PermissionId.PRODUCT,
      },
      {
        id: PermissionId.PRODUCT_MOVEMENT_READ,
        level: 2,
        code: PermissionId[PermissionId.PRODUCT_MOVEMENT_READ],
        isActive: 1,
        pathId: `${PermissionId.PRODUCT}.${PermissionId.PRODUCT_MOVEMENT_READ}`,
