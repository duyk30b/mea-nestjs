...
export class ApiPermissionService {
  ...
  async initData() {
    ...
    const permissionReceipt: Permission[] = [
      ...
      {
        id: PermissionId.RECEIPT_DRAFT_UPSERT,
        level: 2,
        code: PermissionId[PermissionId.RECEIPT_DRAFT_UPSERT],
        isActive: 1,
        pathId: `${PermissionId.RECEIPT}.${PermissionId.RECEIPT_DRAFT_UPSERT}`,
    ...
    const permissionTicketOrder: Permission[] = [
      ...
      {
        id: PermissionId.TICKET_ORDER_DRAFT_UPSERT,
        level: 2,
        code: PermissionId[PermissionId.TICKET_ORDER_DRAFT_UPSERT],
        isActive: 1,
        pathId: `${PermissionId.TICKET_ORDER}.${PermissionId.TICKET_ORDER_DRAFT_UPSERT}`,
      ...
      {
        id: PermissionId.TICKET_ORDER_VOIDED_DESTROY,
        level: 2,
        code: PermissionId[PermissionId.TICKET_ORDER_VOIDED_DESTROY],
        isActive: 1,
        pathId: `${PermissionId.TICKET_ORDER}.${PermissionId.TICKET_ORDER_VOIDED_DESTROY}`,
