export enum SOCKET_EVENT {
  ...
  TICKET_CLINIC_UPDATE_TICKET_LABORATORY_LIST = 'TICKET_CLINIC_UPDATE_TICKET_LABORATORY_LIST',
  TICKET_CLINIC_UPDATE_TICKET_LABORATORY_RESULT = 'TICKET_CLINIC_UPDATE_TICKET_LABORATORY_RESULT',
  TICKET_CLINIC_UPDATE_TICKET_RADIOLOGY_LIST = 'TICKET_CLINIC_UPDATE_TICKET_RADIOLOGY_LIST',
  TICKET_CLINIC_UPDATE_TICKET_RADIOLOGY_RESULT = 'TICKET_CLINIC_UPDATE_TICKET_RADIOLOGY_RESULT',
