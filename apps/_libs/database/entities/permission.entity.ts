...
export enum PermissionId {
  ...
  TICKET_ORDER_DRAFT_UPSERT = 5001,
  ...
  TICKET_ORDER_VOIDED_DESTROY = 5014,
  TICKET_ORDER_DOWNLOAD_EXCEL = 5030,
  ...
  TICKET_CLINIC_DOWNLOAD_EXCEL = 5130,
