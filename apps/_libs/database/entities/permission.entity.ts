...
export enum PermissionId {
  ...
  INVOICE = 10,
  INVOICE_READ = 1000,
  INVOICE_CREATE_DRAFT = 1001,
  INVOICE_PREPAYMENT = 1002,
  INVOICE_REFUND_PREPAYMENT = 1003,
  INVOICE_SEND_PRODUCT = 1004,
  INVOICE_PAY_DEBT = 1005,
  INVOICE_UPDATE_INVOICE_DRAFT_AND_INVOICE_PREPAYMENT = 1006,
  INVOICE_UPDATE_INVOICE_DEBT_AND_INVOICE_SUCCESS = 1007,
  INVOICE_RETURN_PRODUCT = 1008,
  INVOICE_DELETE = 1009,
  ...
  VISIT_REPLACE_VISIT_PROCEDURE_LIST = 1104,
  VISIT_REPLACE_VISIT_RADIOLOGY_LIST = 1105,
  VISIT_PRESCRIPTION = 1106,
  VISIT_UPDATE_ITEMS_MONEY = 1107,
  VISIT_PREPAYMENT = 1108,
  VISIT_REFUND_OVERPAID = 119,
  VISIT_PAY_DEBT = 1110,
  VISIT_SEND_PRODUCT = 1111,
  VISIT_RETURN_PRODUCT = 1112,
  VISIT_CLOSE = 1113,
  VISIT_REOPEN = 1114,
  VISIT_RADIOLOGY_UPSERT = 1150,
