...
export enum PermissionId {
  ...
  TICKET_CLINIC_REGISTER_NEW = 5101,
  ...
  TICKET_CLINIC_BASE = 52,
  TICKET_CLINIC_BASE_UPDATE_DIAGNOSIS = 5201,

  TICKET_CLINIC_EYE = 53,
  TICKET_CLINIC_EYE_UPDATE_DIAGNOSIS_BASIC = 5301,
  TICKET_CLINIC_EYE_UPDATE_DIAGNOSIS_SPECIAL = 5302,
}
