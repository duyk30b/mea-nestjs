...
export enum PaymentVoucherTiming {
  Other = 0, // Không xác định
  Prepayment = 1, // Tạm ứng
...
export default class PaymentItem {
  ...
  @Column({ type: 'smallint', default: PaymentVoucherTiming.TopUp })
  @Expose()
  paymentVoucherTiming: PaymentVoucherTiming
...
export type PaymentItemRelationType = {
  [P in keyof Pick<PaymentItem, 'customer' | 'distributor' | 'employee'>]?: boolean
}
