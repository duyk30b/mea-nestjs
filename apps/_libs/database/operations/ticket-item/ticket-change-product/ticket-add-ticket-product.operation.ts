...
export type TicketProductAddDtoType = Omit<
  TicketProduct,
...
@Injectable()
export class TicketAddTicketProductOperation {
  constructor(
  ...
  async addTicketProductList<T extends TicketProductAddDtoType>(params: {
    oid: number
    ticketId: number
    ticketProductType: TicketProductType
    ticketProductDtoList: NoExtra<TicketProductAddDtoType, T>[]
  }) {
