...
import { TicketManager, TicketRadiologyManager, TicketUserManager } from '../../../managers'
import { TicketChangeItemMoneyManager } from '../../ticket-base/ticket-change-item-money.manager'

@Injectable()
export class TicketClinicDestroyTicketRadiologyOperation {
  constructor(
  ...
  async destroyTicketRadiology(params: {
    ...
    const transaction = await this.dataSource.transaction('READ UNCOMMITTED', async (manager) => {
      ...
      if (radiologyMoneyDelete != 0 || commissionMoneyDelete != 0) {
