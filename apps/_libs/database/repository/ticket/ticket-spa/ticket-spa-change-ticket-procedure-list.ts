...
export type TicketSpaProcedureChangeDtoType = Omit<
  TicketProcedure,
...
@Injectable()
export class TicketSpaChangeTicketProcedureList {
  constructor(private dataSource: DataSource) { }

  async changeTicketProcedureList<T extends TicketSpaProcedureChangeDtoType>(params: {
    oid: number
    ticketId: number
    ticketProcedureListDto: NoExtra<TicketSpaProcedureChangeDtoType, T>[]
  }) {
