...
export const permissionRadiology: Permission[] = [
  ...
  },
  {
    ...
    isActive: 1,
    pathId: `${PermissionId.RADIOLOGY}.${PermissionId.RADIOLOGY_UPDATE_RESULT}`,
    name: 'Trả kết quả phiếu CĐHA',
    parentId: PermissionId.RADIOLOGY,
    rootId: PermissionId.RADIOLOGY,
  },
  {
    id: PermissionId.RADIOLOGY_CANCEL_RESULT,
    level: 2,
    code: PermissionId[PermissionId.RADIOLOGY_CANCEL_RESULT],
    isActive: 1,
    pathId: `${PermissionId.RADIOLOGY}.${PermissionId.RADIOLOGY_CANCEL_RESULT}`,
    name: 'Hủy kết quả phiếu CĐHA',
    parentId: PermissionId.RADIOLOGY,
    rootId: PermissionId.RADIOLOGY,
  },
]
