...
export const permissionStatistic: Permission[] = [
  ...
  {
    id: PermissionId.STATISTIC_DISTRIBUTOR,
    level: 2,
    code: PermissionId[PermissionId.STATISTIC_DISTRIBUTOR],
    isActive: 1,
    pathId: `${PermissionId.STATISTIC}.${PermissionId.STATISTIC_DISTRIBUTOR}`,
    name: 'Xem thống kê nhà cung cấp',
    parentId: PermissionId.STATISTIC,
    rootId: PermissionId.STATISTIC,
  },
  {
