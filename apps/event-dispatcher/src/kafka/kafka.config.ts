...
export const KafkaConfig = registerAs('kafka', () => ({
  ...
  event: {
    ...
    arrival_create: process.env.KAFKA_VISIT_CREATE,
    arrival_update: process.env.KAFKA_VISIT_UPDATE,
  },
}))
...
export enum KAFKA_EVENT {
  ...
  VISIT_CREATE = 'kafka.event.arrival_create',
  VISIT_UPDATE = 'kafka.event.arrival_update',
}
